...
namespace EmailServiceBus
{
    ...
    {
        private  string ServiceBusConnectionString { get; set; } = "Endpoint=sb://mangowebbt.servicebus.windows.net/;SharedAccessKeyName=EmailServiceBus;SharedAccessKey=3uCh5iEkHGfr9PWtstbzuh4TJ48ZhNU6k+ASbDudKZ0=;EntityPath=mangoemailsurvicebus"
